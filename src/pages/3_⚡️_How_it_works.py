...
:white_check_mark: At this moment, **Generative Manim** is able to render simple animations that rely on Manim and Math packages. But it's not able to render complex animations that could require more lines of code that the limit of tokens provided by GPT-3.5 or GPT-4.
